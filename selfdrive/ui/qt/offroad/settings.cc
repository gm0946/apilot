...
TuningPanel::TuningPanel(QWidget* parent) : QWidget(parent) {
    ...
    toggleLayout->addWidget(new CValueControl("DesiredCurvatureCost", "LAT: DesiredCurvatureCost(100)", "코너에서 한쪽으로 치우칠 때 값을 조정합니다 100 == 1.1", "../assets/offroad/icon_road.png", 0, 100, 1));
